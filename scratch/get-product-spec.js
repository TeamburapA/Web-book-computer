...
const productId = 'na90jncjlvw5t0ba';
...
async function run() {
  try {
    ...
    console.log('Querying product specifications for:', productId);
    const specsResult = await queryEndpoint(token, `/v1.0/products/${productId}/specifications`);
